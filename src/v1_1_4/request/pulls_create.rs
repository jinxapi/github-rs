...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::pulls_create::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::pulls_create::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::pulls_create::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::pulls_create::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::pulls_create`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub head: ::std::borrow::Cow<'a, str>,

        /// The name of the branch you want the changes pulled into. This should be an existing branch on the current repository. You cannot submit a pull request to one repository that requests a merge to a base of another repository.
        pub base: ::std::borrow::Cow<'a, str>,
        ...
        /// ```
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub issue: ::std::option::Option<i64>,
