...
fn url_string(
    ...
    ::querylizer::Simple::extend(&mut url, &p_installation_id, false, &::querylizer::encode_path)?;
    url.push_str("/access_tokens");
    Ok(url)
}
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::apps_create_installation_access_token::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::apps_create_installation_access_token::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::apps_create_installation_access_token::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::apps_create_installation_access_token::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::apps_create_installation_access_token`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub repositories: ::std::option::Option<::std::borrow::Cow<'a, [::std::borrow::Cow<'a, str>]>>,
        ...
        /// ```
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub repository_ids: ::std::option::Option<::std::borrow::Cow<'a, [i64]>>,

        /// App Permissions
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub permissions: ::std::option::Option<crate::v1_1_4::schema::AppPermissions<'a>>,
