...
fn url_string(
    ...
    ::querylizer::Simple::extend(&mut url, &p_deployment_id, false, &::querylizer::encode_path)?;
    url.push_str("/statuses");
    Ok(url)
}
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_create_deployment_status::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::repos_create_deployment_status::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_create_deployment_status::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_create_deployment_status::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::repos_create_deployment_status`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub state: ::std::borrow::Cow<'a, str>,

        /// The target URL to associate with this status. This URL should contain output to keep the user updated while the task is running or serve as historical information for what happened in the deployment. **Note:** It's recommended to use the `log_url` parameter, which replaces `target_url`.
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub target_url: ::std::option::Option<::std::borrow::Cow<'a, str>>,

        /// The full URL of the deployment's output. This parameter replaces `target_url`. We will continue to accept `target_url` to support legacy uses, but we recommend replacing `target_url` with `log_url`. Setting `log_url` will automatically set `target_url` to the same value. Default: `""`
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub log_url: ::std::option::Option<::std::borrow::Cow<'a, str>>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub environment_url: ::std::option::Option<::std::borrow::Cow<'a, str>>,

        /// Adds a new `inactive` status to all prior non-transient, non-production environment deployments with the same repository and `environment` name as the created status's deployment. An `inactive` status is only added to deployments that had a `success` state. Default: `true`
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub auto_inactive: ::std::option::Option<bool>,
