...
/// Types for body parameter in [`super::repos_create_fork`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub organization: ::std::option::Option<::std::borrow::Cow<'a, str>>,
    ...
    #[cfg(feature = "hyper")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::repos_create_fork::body::Json<'a>>> for super::Content<::hyper::Body> {
        type Error = crate::v1_1_4::ApiError;

        fn try_from(value: &::std::option::Option<crate::v1_1_4::request::repos_create_fork::body::Json<'a>>) -> Result<Self, Self::Error> {
            Ok(
    ...
    #[cfg(feature = "reqwest")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::repos_create_fork::body::Json<'a>>> for super::Content<::reqwest::Body> {
        type Error = crate::v1_1_4::ApiError;
    ...
    #[cfg(feature = "reqwest-blocking")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::repos_create_fork::body::Json<'a>>> for super::Content<::reqwest::blocking::Body> {
        type Error = crate::v1_1_4::ApiError;
