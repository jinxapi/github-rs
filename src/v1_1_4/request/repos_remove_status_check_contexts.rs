...
fn url_string(
    ...
    let mut url = String::with_capacity(trimmed.len() + 80);
    ...
    url.push_str("/protection/required_status_checks/contexts");
    Ok(url)
}
...
/// Types for body parameter in [`super::repos_remove_status_check_contexts`]
pub mod body {
    #[cfg(feature = "hyper")]
