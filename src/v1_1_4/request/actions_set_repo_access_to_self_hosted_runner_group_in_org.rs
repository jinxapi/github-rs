...
fn url_string(
    ...
    let mut url = String::with_capacity(trimmed.len() + 60);
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::actions_set_repo_access_to_self_hosted_runner_group_in_org::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::actions_set_repo_access_to_self_hosted_runner_group_in_org::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::actions_set_repo_access_to_self_hosted_runner_group_in_org::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::actions_set_repo_access_to_self_hosted_runner_group_in_org::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::actions_set_repo_access_to_self_hosted_runner_group_in_org`]
pub mod body {
