...
/// Types for body parameter in [`super::pulls_update_branch`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub expected_head_sha: ::std::option::Option<::std::borrow::Cow<'a, str>>,
    ...
    #[cfg(feature = "hyper")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::pulls_update_branch::body::Json<'a>>> for super::Content<::hyper::Body> {
        type Error = crate::v1_1_4::ApiError;

        fn try_from(value: &::std::option::Option<crate::v1_1_4::request::pulls_update_branch::body::Json<'a>>) -> Result<Self, Self::Error> {
            Ok(
    ...
    #[cfg(feature = "reqwest")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::pulls_update_branch::body::Json<'a>>> for super::Content<::reqwest::Body> {
        type Error = crate::v1_1_4::ApiError;
    ...
    #[cfg(feature = "reqwest-blocking")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::pulls_update_branch::body::Json<'a>>> for super::Content<::reqwest::blocking::Body> {
        type Error = crate::v1_1_4::ApiError;
