...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_update_information_about_pages_site::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::repos_update_information_about_pages_site::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_update_information_about_pages_site::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_update_information_about_pages_site::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::repos_update_information_about_pages_site`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub cname: ::std::option::Option<::std::option::Option<::std::borrow::Cow<'a, str>>>,

        /// Specify whether HTTPS should be enforced for the repository.
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub https_enforced: ::std::option::Option<bool>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub source: ::std::option::Option<::serde_json::value::Value>,
