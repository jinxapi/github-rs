...
fn url_string(
    ...
    url.push_str("/notifications/threads/");
    ::querylizer::Simple::extend(&mut url, &p_thread_id, false, &::querylizer::encode_path)?;
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::activity_set_thread_subscription::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::activity_set_thread_subscription::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::activity_set_thread_subscription::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::activity_set_thread_subscription::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::activity_set_thread_subscription`]
pub mod body {
