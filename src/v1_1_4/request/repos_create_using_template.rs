...
fn url_string(
    ...
    url.push_str("/repos/");
    ::querylizer::Simple::extend(&mut url, &p_template_owner, false, &::querylizer::encode_path)?;
    url.push('/');
    ::querylizer::Simple::extend(&mut url, &p_template_repo, false, &::querylizer::encode_path)?;
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_create_using_template::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::repos_create_using_template::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_create_using_template::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_create_using_template::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::repos_create_using_template`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub owner: ::std::option::Option<::std::borrow::Cow<'a, str>>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub include_all_branches: ::std::option::Option<bool>,
