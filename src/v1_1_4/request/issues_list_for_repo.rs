...
fn url_string(
    ...
    p_owner: &str,
    p_repo: &str,
    q_milestone: ::std::option::Option<&str>,
    q_state: ::std::option::Option<&str>,
    q_assignee: ::std::option::Option<&str>,
    q_creator: ::std::option::Option<&str>,
    q_mentioned: ::std::option::Option<&str>,
    ...
    url.push_str("/issues");
    let mut prefix = '?';
    if let Some(value) = &q_milestone {
        url.push(::std::mem::replace(&mut prefix, '&'));
        ::querylizer::Form::extend(&mut url, "milestone", value, false, &::querylizer::encode_query)?;
    }
    if let Some(value) = &q_state {
        url.push(::std::mem::replace(&mut prefix, '&'));
        ::querylizer::Form::extend(&mut url, "state", value, false, &::querylizer::encode_query)?;
    }
    if let Some(value) = &q_assignee {
        url.push(::std::mem::replace(&mut prefix, '&'));
        ::querylizer::Form::extend(&mut url, "assignee", value, false, &::querylizer::encode_query)?;
    }
    if let Some(value) = &q_creator {
        url.push(::std::mem::replace(&mut prefix, '&'));
        ::querylizer::Form::extend(&mut url, "creator", value, false, &::querylizer::encode_query)?;
    }
    if let Some(value) = &q_mentioned {
        url.push(::std::mem::replace(&mut prefix, '&'));
        ::querylizer::Form::extend(&mut url, "mentioned", value, false, &::querylizer::encode_query)?;
    }
