...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::orgs_create_webhook::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::orgs_create_webhook::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::orgs_create_webhook::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::orgs_create_webhook::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::orgs_create_webhook`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub config: crate::v1_1_4::request::orgs_create_webhook::body::json::Config<'a>,
    ...
    pub mod json {
        ...
        pub struct Config<'a> {
            ...
            /// ```
            #[serde(skip_serializing_if = "Option::is_none", default)]
            pub username: ::std::option::Option<::std::borrow::Cow<'a, str>>,
            ...
            /// ```
            #[serde(skip_serializing_if = "Option::is_none", default)]
            pub password: ::std::option::Option<::std::borrow::Cow<'a, str>>,
