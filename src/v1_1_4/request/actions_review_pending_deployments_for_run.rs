...
fn url_string(
    ...
    let mut url = String::with_capacity(trimmed.len() + 61);
    ...
    url.push_str("/pending_deployments");
    Ok(url)
}
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::actions_review_pending_deployments_for_run::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::actions_review_pending_deployments_for_run::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::actions_review_pending_deployments_for_run::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::actions_review_pending_deployments_for_run::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::actions_review_pending_deployments_for_run`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        /// ]
        /// ```
        pub environment_ids: ::std::borrow::Cow<'a, [i64]>,
        ...
        /// "Ship it!"
        /// ```
        pub comment: ::std::borrow::Cow<'a, str>,
