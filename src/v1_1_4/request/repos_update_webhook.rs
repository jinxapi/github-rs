...
fn url_string(
    ...
    url.push_str("/hooks/");
    ::querylizer::Simple::extend(&mut url, &p_hook_id, false, &::querylizer::encode_path)?;
    Ok(url)
}
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_update_webhook::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::repos_update_webhook::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_update_webhook::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::repos_update_webhook::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::repos_update_webhook`]
pub mod body {
    #[allow(non_snake_case)]
    #[derive(Clone, Eq, PartialEq, Debug, Default, ::serde::Serialize, ::serde::Deserialize)]
    pub struct Json<'a> {
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub config: ::std::option::Option<crate::v1_1_4::request::repos_update_webhook::body::json::Config<'a>>,

        /// Determines what [events](https://docs.github.com/webhooks/event-payloads) the hook is triggered for. This replaces the entire array of events.
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub events: ::std::option::Option<::std::borrow::Cow<'a, [::std::borrow::Cow<'a, str>]>>,

        /// Determines a list of events to be added to the list of events that the Hook triggers for.
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub add_events: ::std::option::Option<::std::borrow::Cow<'a, [::std::borrow::Cow<'a, str>]>>,

        /// Determines a list of events to be removed from the list of events that the Hook triggers for.
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub remove_events: ::std::option::Option<::std::borrow::Cow<'a, [::std::borrow::Cow<'a, str>]>>,
    ...
    pub mod json {
        ...
        pub struct Config<'a> {
            ...
            /// ```
            #[serde(skip_serializing_if = "Option::is_none", default)]
            pub address: ::std::option::Option<::std::borrow::Cow<'a, str>>,
            ...
            /// ```
            #[serde(skip_serializing_if = "Option::is_none", default)]
            pub room: ::std::option::Option<::std::borrow::Cow<'a, str>>,
