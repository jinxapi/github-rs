...
pub fn http_builder(
    ...
    let default_url = concat!("https://api.github.com", "/user/gpg_keys");
...
/// Types for body parameter in [`super::users_create_gpg_key_for_authenticated_user`]
pub mod body {
    #[allow(non_snake_case)]
    #[derive(Clone, Eq, PartialEq, Debug, Default, ::serde::Serialize, ::serde::Deserialize)]
    pub struct Json<'a> {
        /// A GPG key in ASCII-armored format.
        pub armored_public_key: ::std::borrow::Cow<'a, str>,
