...
fn url_string(
    ...
    let mut url = String::with_capacity(trimmed.len() + 54);
    ...
    url.push_str("/requested_reviewers");
    Ok(url)
}
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::pulls_remove_requested_reviewers::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::pulls_remove_requested_reviewers::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::pulls_remove_requested_reviewers::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::pulls_remove_requested_reviewers::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::pulls_remove_requested_reviewers`]
pub mod body {
    #[allow(non_snake_case)]
    #[derive(Clone, Eq, PartialEq, Debug, Default, ::serde::Serialize, ::serde::Deserialize)]
    pub struct Json<'a> {
        /// An array of user `login`s that will be removed.
        pub reviewers: ::std::borrow::Cow<'a, [::std::borrow::Cow<'a, str>]>,

        /// An array of team `slug`s that will be removed.
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub team_reviewers: ::std::option::Option<::std::borrow::Cow<'a, [::std::borrow::Cow<'a, str>]>>,
