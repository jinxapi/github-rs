...
/// Types for body parameter in [`super::enterprise_admin_update_attribute_for_enterprise_user`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub operations: ::std::borrow::Cow<'a, [::std::collections::HashMap<::std::borrow::Cow<'a, str>, ::serde_json::value::Value>]>,
