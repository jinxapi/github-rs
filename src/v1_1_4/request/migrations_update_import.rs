...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::migrations_update_import::body::Json<'a>>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &::std::option::Option<crate::v1_1_4::request::migrations_update_import::body::Json<'a>>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::migrations_update_import::body::Json<'a>>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::migrations_update_import::body::Json<'a>>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::migrations_update_import`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub vcs_username: ::std::option::Option<::std::borrow::Cow<'a, str>>,
        ...
        /// ```
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub tfvc_project: ::std::option::Option<::std::borrow::Cow<'a, str>>,
