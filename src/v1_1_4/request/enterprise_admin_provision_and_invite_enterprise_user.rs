...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::enterprise_admin_provision_and_invite_enterprise_user::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::enterprise_admin_provision_and_invite_enterprise_user::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::enterprise_admin_provision_and_invite_enterprise_user::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::enterprise_admin_provision_and_invite_enterprise_user::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::enterprise_admin_provision_and_invite_enterprise_user`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub name: crate::v1_1_4::request::enterprise_admin_provision_and_invite_enterprise_user::body::json::Name<'a>,

        /// List of user emails.
        pub emails: ::std::borrow::Cow<'a, [crate::v1_1_4::request::enterprise_admin_provision_and_invite_enterprise_user::body::json::Emails<'a>]>,

        /// List of SCIM group IDs the user is a member of.
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub groups: ::std::option::Option<::std::borrow::Cow<'a, [crate::v1_1_4::request::enterprise_admin_provision_and_invite_enterprise_user::body::json::Groups<'a>]>>,
