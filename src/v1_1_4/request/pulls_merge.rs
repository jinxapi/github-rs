...
/// Types for body parameter in [`super::pulls_merge`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub commit_title: ::std::option::Option<::std::borrow::Cow<'a, str>>,

        /// Extra detail to append to automatic commit message.
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub commit_message: ::std::option::Option<::std::borrow::Cow<'a, str>>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub merge_method: ::std::option::Option<::std::borrow::Cow<'a, str>>,
    ...
    #[cfg(feature = "hyper")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::pulls_merge::body::Json<'a>>> for super::Content<::hyper::Body> {
        type Error = crate::v1_1_4::ApiError;

        fn try_from(value: &::std::option::Option<crate::v1_1_4::request::pulls_merge::body::Json<'a>>) -> Result<Self, Self::Error> {
            Ok(
    ...
    #[cfg(feature = "reqwest")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::pulls_merge::body::Json<'a>>> for super::Content<::reqwest::Body> {
        type Error = crate::v1_1_4::ApiError;
    ...
    #[cfg(feature = "reqwest-blocking")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::pulls_merge::body::Json<'a>>> for super::Content<::reqwest::blocking::Body> {
        type Error = crate::v1_1_4::ApiError;
