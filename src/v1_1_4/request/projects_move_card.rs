...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::projects_move_card::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::projects_move_card::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::projects_move_card::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::projects_move_card::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::projects_move_card`]
pub mod body {
