...
pub fn http_builder(
    ...
    let default_url = concat!("https://api.github.com", "/authorizations");
    let url = if base_url.is_empty() {
        ::http::uri::Uri::from_static(default_url)
    } else {
        let trimmed = base_url.trim_end_matches('/');
        let mut url = String::with_capacity(trimmed.len() + 15);
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::oauth_authorizations_create_authorization::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::oauth_authorizations_create_authorization::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::oauth_authorizations_create_authorization::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::oauth_authorizations_create_authorization::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::oauth_authorizations_create_authorization`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub client_id: ::std::option::Option<::std::borrow::Cow<'a, str>>,

        /// The OAuth app client secret for which to create the token.
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub client_secret: ::std::option::Option<::std::borrow::Cow<'a, str>>,
