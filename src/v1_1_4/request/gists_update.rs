...
fn url_string(
    ...
    let mut url = String::with_capacity(trimmed.len() + 24);
    url.push_str(trimmed);
    url.push_str("/gists/");
    ::querylizer::Simple::extend(&mut url, &p_gist_id, false, &::querylizer::encode_path)?;
    Ok(url)
}
...
/// Types for body parameter in [`super::gists_update`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub files: ::std::option::Option<::std::collections::HashMap<::std::borrow::Cow<'a, str>, ::std::option::Option<crate::v1_1_4::request::gists_update::body::json::Files<'a>>>>,
    ...
    pub mod json {
        ...
        pub struct Files<'a> {
            ...
            pub filename: ::std::option::Option<::std::option::Option<::std::borrow::Cow<'a, str>>>,
    ...
    #[cfg(feature = "hyper")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::gists_update::body::Json<'a>>> for super::Content<::hyper::Body> {
        type Error = crate::v1_1_4::ApiError;

        fn try_from(value: &::std::option::Option<crate::v1_1_4::request::gists_update::body::Json<'a>>) -> Result<Self, Self::Error> {
            Ok(
    ...
    #[cfg(feature = "reqwest")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::gists_update::body::Json<'a>>> for super::Content<::reqwest::Body> {
        type Error = crate::v1_1_4::ApiError;
    ...
    #[cfg(feature = "reqwest-blocking")]
    impl<'a> TryFrom<&::std::option::Option<crate::v1_1_4::request::gists_update::body::Json<'a>>> for super::Content<::reqwest::blocking::Body> {
        type Error = crate::v1_1_4::ApiError;
