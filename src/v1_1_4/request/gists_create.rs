...
pub fn http_builder(
    ...
    let default_url = concat!("https://api.github.com", "/gists");
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::gists_create::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::gists_create::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::gists_create::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::gists_create::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::gists_create`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub files: ::std::collections::HashMap<::std::borrow::Cow<'a, str>, crate::v1_1_4::request::gists_create::body::json::Files<'a>>,

        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub public: ::std::option::Option<::serde_json::value::Value>,
