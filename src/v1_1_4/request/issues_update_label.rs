...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::issues_update_label::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::issues_update_label::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::issues_update_label::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::issues_update_label::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::issues_update_label`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub new_name: ::std::option::Option<::std::borrow::Cow<'a, str>>,

        /// The [hexadecimal color code](http://www.color-hex.com/) for the label, without the leading `#`.
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub color: ::std::option::Option<::std::borrow::Cow<'a, str>>,
