...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::activity_mark_repo_notifications_as_read::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::activity_mark_repo_notifications_as_read::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::activity_mark_repo_notifications_as_read::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::activity_mark_repo_notifications_as_read::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::activity_mark_repo_notifications_as_read`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        pub last_read_at: ::std::option::Option<::std::borrow::Cow<'a, str>>,
