...
fn url_string(
    ...
    url.push_str("/dependabot/secrets/");
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::dependabot_create_or_update_org_secret::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::dependabot_create_or_update_org_secret::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::dependabot_create_or_update_org_secret::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::dependabot_create_or_update_org_secret::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::dependabot_create_or_update_org_secret`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        #[serde(skip_serializing_if = "Option::is_none", default)]
        pub key_id: ::std::option::Option<::std::borrow::Cow<'a, str>>,
