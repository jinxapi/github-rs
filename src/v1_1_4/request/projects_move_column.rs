...
fn url_string(
    ...
    url.push_str("/projects/columns/");
    ::querylizer::Simple::extend(&mut url, &p_column_id, false, &::querylizer::encode_path)?;
    url.push_str("/moves");
    Ok(url)
}
...
#[cfg(feature = "hyper")]
impl<'a> TryFrom<&crate::v1_1_4::request::projects_move_column::body::Json<'a>> for Content<::hyper::Body> {
    type Error = crate::v1_1_4::ApiError;

    fn try_from(value: &crate::v1_1_4::request::projects_move_column::body::Json<'a>) -> Result<Self, Self::Error> {
        Ok(
...
#[cfg(feature = "reqwest")]
impl<'a> TryFrom<&crate::v1_1_4::request::projects_move_column::body::Json<'a>> for Content<::reqwest::Body> {
    type Error = crate::v1_1_4::ApiError;
...
#[cfg(feature = "reqwest-blocking")]
impl<'a> TryFrom<&crate::v1_1_4::request::projects_move_column::body::Json<'a>> for Content<::reqwest::blocking::Body> {
    type Error = crate::v1_1_4::ApiError;
...
/// Types for body parameter in [`super::projects_move_column`]
pub mod body {
    ...
    pub struct Json<'a> {
        ...
        /// "last"
        /// ```
        pub position: ::std::borrow::Cow<'a, str>,
